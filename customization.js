...
cartBtn.addEventListener('click' , function() {
    alert("Success!!!! You added " + newQuantity + " item(s) is in the cart.");
    addToCart(newType , newColor, newFill, newQuantity);
})



function addToCart(productType,productColor, productFill,productQuantity) {
     const newItem = new Product(productType,productColor, productFill,productQuantity);
     cart.push (newItem);
     console.log ("hiiii");
